...
def draw_barchart(year):
    ...
    ax.text(1, 0, 'by @statisticaindia; credit @jburnmurdoch', transform=ax.transAxes, ha='right',
...
fig, ax = plt.subplots(figsize=(15, 8))
animator = animation.FuncAnimation(fig, draw_barchart, frames=range(1500, 2020))
animator.save("expt1.mp4")
